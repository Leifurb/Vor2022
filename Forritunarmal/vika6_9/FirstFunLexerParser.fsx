...
(*
Let us extend the lexer and parser for the expressions language
to the boolean type and first-order functions.
*)
...
(*
The challenge in the parser is to correctly handle
