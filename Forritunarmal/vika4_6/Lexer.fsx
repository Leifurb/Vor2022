...
Let ("z", Num 17, Op ("+",Var "z", Var "x"))

parsing goes through a list of tokens, in our case

[LET; NAME "z"; EQUAL; INT 17; IN; NAME "z"; PLUS; NAME "x"]
...
(*
This is only applied to strings that qualify as words,
so we don't have to worry about "hello world" or "1fs".
*)
