...
For +, *, right-associativity is adequate. (Since +, * are
semantically associative, it does not matter if they
are treated as left- or right-associative.)

For -, right-asociativity is unfortunate; we really want
left-associativity, since
...
for expressions, summands and factors.
*)
